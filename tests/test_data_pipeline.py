...
class TestCNNDMLoader:
    ...
    def test_load_with_max_samples(self):
        ...
        test_data = [
            {"id": f"test_{i}", "article": f"Article {i}", "highlights": f"Summary {i}"}
            for i in range(10)
        ]
...
class TestDataValidator:
    ...
    def test_validate_sample_failure(self):
        ...
        validator = DataValidator(min_article_length=100, min_summary_length=20)
...
class TestJSONAnnotationHandler:
    ...
    def test_validate_annotation(self):
        ...
        invalid_annotation = {
            "id": "test_1",
            "annotations": {"quality_score": 1.5},  # Invalid range
        }
    ...
    def test_save_load_annotations(self):
        ...
        annotations = [
            {"id": "test_1", "annotations": {"quality_score": 0.8}},
            {"id": "test_2", "annotations": {"quality_score": 0.9}},
        ]

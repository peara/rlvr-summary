...
class EntityOverlapRule(BaseRule):
    ...
    def evaluate(self, source: str, summary: str) -> Dict[str, Any]:
        ...
        jaccard_score = TextProcessor.jaccard_similarity(
            source_entities, summary_entities
        )
        ...
        result = {
            ...
            "details": {
                ...
                "entity_overlap_count": len(
                    source_entities.intersection(summary_entities)
                ),
    ...
    def evaluate(self, source: str, summary: str) -> Dict[str, Any]:
        ...
        if not summary_numbers:
            ...
            details = {
                ...
                "exact_match_ratio": (
                    num_exact_matches / num_summary_numbers
                    if num_summary_numbers > 0
                    else 0
                ),
                "mismatch_ratio": (
                    num_mismatches / num_summary_numbers
                    if num_summary_numbers > 0
                    else 0
                ),
    ...
    def evaluate(self, source: str, summary: str) -> Dict[str, Any]:
        ...
        if wordlist_path:
            try:
                ...
                self.logger.warning(
                    f"Profanity wordlist not found: {wordlist_path}, using default"
                )
